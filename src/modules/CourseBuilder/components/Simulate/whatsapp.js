                        ...
                        <div className="conversation">
                          <div className="conversation-container">
                            <div className="message received">
                              (3/8) Those droplets can travel about 2-6 meters and can enter another
                              persons nose, mouth or ears. Continue
                            ...
                            <div className="message received">
                              <span id="random">
                                (3/8) Those droplets can travel about 2-6 meters and can enter
                                another persons nose, mouth or ears. Continue
                              </span>
                              <span className="metadata">
                                <span className="time"></span>
                              </span>
