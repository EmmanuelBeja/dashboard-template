...
const Root = (props) => {
  return (
    <div className="tree-menu__card-root">
      ...
      <div className="tree-list__item">2. COVID-19 Prevention</div>
      <div className="tree-list__item">3. Facts about covid</div>
    </div>
  )
}

const MenuViewCard = (props) => {
  const { toggle, toggleKey, collapse } = props

  return (
    <div className="tree-menu__card-children">
      <div className="panel-group panel-group__menu">
        <div className="panel panel-default">
          <div className="panel-heading">
            <h4 className="panel-title">
              <Button onClick={() => toggle(toggleKey)}>Lesson 1. Facts about Covid</Button>
